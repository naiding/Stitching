...
/**
 * Servlet implementation class StitchVideo
 */
@WebServlet("/stitchvideo")
public class StitchVideo extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    private static final String UPLOAD_DIRECTORY = "uploaded_video";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<FileItem> formItems = upload.parseRequest(request);
            	...
            	VideoStitcher stitcher = new VideoStitcher(videoFile);
